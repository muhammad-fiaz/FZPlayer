...
public final class MylandBinding implements ViewBinding {
  @NonNull
  ...
  private MylandBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView aspectbtn,
  ...
  @NonNull
  public static MylandBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static MylandBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.myland, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MylandBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MylandBinding((ConstraintLayout) rootView, aspectbtn, bottomview, currentprogress,
          dragseek, endprogress, imageButton, imageButton2, imageButton3, player, progresstext,
          seekdelay, seeklay, seektime, toucher, volumecontainer, volumeicon, volumeview);
    }
